...
public class ProductService {
    ...
    public Page<Product> getProductPaginationWithFilter(Pageable page, ProductCriteriaDTO productCriteriaDTO) {
        ...
        if (productCriteriaDTO.getTarget() != null && productCriteriaDTO.getTarget().isPresent()) {
            Specification<Product> currentSpecs = ProductSpecs.nameTargetsLike(productCriteriaDTO.getTarget().get());
            combinedSpec = combinedSpec.and(currentSpecs);
        }

        if (productCriteriaDTO.getFactory() != null && productCriteriaDTO.getFactory().isPresent()) {
            Specification<Product> currentSpecs = ProductSpecs.nameFactorysLike(productCriteriaDTO.getFactory().get());
            combinedSpec = combinedSpec.and(currentSpecs);
        }
    ...
    public void handlePlaceOrder(User currentUser, String receiverName, String receiverAddress, String receiverPhone,
            HttpSession session, String paymentMethod, String uuid) {
